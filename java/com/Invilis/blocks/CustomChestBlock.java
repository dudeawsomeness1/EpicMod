...
public class CustomChestBlock extends Block implements IWaterLoggable {
    ...
    public CustomChestBlock(Properties properties, ChestType type)
    {
        super(properties);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack)
    {
        ...
        {
            ((MithrilChestTileEntity) tileentity).wasPlaced(placer, stack);

            if (stack.hasDisplayName())
            {
                ((MithrilChestTileEntity) tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving)
    {
        if (state.getBlock() != newState.getBlock())
        {
            ...
            if (tileentity instanceof MithrilChestTileEntity)
            {
                ((MithrilChestTileEntity) tileentity).removeAdornments();
                InventoryHelper.dropInventoryItems(worldIn, pos, (MithrilChestTileEntity) tileentity);
    ...
    {
        return blockIn instanceof CustomChestBlock ? ((CustomChestBlock) blockIn).getType() : null;
    }
