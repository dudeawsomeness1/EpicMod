...
import com.Invilis.inventory.CustomChestContainer;
...
public class MithrilChestTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity {
    ...
    protected MithrilChestTileEntity(TileEntityType<?> typeIn, ChestType chestTypeIn, Block blockToUseIn)
    {
        super(typeIn);
	...
	public MithrilChestTileEntity()
    {
        this(ChestTileEntityType.MITHRIL_CHEST, ChestType.MITHRIL, EpicBlocks.mithrilChest);
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory)
    {
        return CustomChestContainer.createMithrilContainer(id, playerInventory, this);
    }
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos posIn)
    {
        ...
        if (blockstate.hasTileEntity())
        {
            ...
            if (tileentity instanceof MithrilChestTileEntity)
            {
                return ((MithrilChestTileEntity) tileentity).numPlayersUsing;
            }
        }
    ...
    {
        ChestType type = ChestType.MITHRIL;

        if (this.hasWorld())
        {
            ChestType typeNew = CustomChestBlock.getTypeFromBlock(this.getBlockState().getBlock());
