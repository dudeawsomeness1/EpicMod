...
public class ElvenBiomeProvider extends BiomeProvider {
	...
	public static class BiomeLayerCustom implements IC0Transformer {
		...
		public int apply(INoiseRandom context, int value) {
			return Registry.BIOME.getId(ElvenDimension.dimensionBiomes[context.random(ElvenDimension.dimensionBiomes.length)]);
		}
	}

	public ElvenBiomeProvider(World world) {
		Layer[] aLayer = makeTheWorld(world.getSeed());
		this.genBiomes = aLayer[0];
		this.biomeFactoryLayer = aLayer[1];
		for (Biome biome : ElvenDimension.dimensionBiomes) {
