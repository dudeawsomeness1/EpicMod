...
public class MithrilChestGUI {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName(EpicMod.MOD_ID, "mithril_chest_gui"));
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public void initContainer(PlayerInventory inv, IInventory inheritedinv) {
			...
			this.addSlot(new Slot(inherited, 0, 8, 12) {
			});
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				EpicMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("epic:textures/mithril_chest_gui.png");
